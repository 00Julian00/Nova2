...
class InferenceEngineBaseTTS:
    ...
    def initialize_model(self, model: Literal["eleven_multilingual_v2", "eleven_flash_v2_5", "eleven_turbo_v2_5"]):
        """
    ...
    def run_inference(self, text: str, conditioning: TTSConditioning, stream: bool) -> list[bytes]:
        """
